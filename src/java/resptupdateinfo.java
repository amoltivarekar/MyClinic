 ...
 * @author microsoft
 */
public class resptupdateinfo extends HttpServlet {
String sur;
    /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("update resptselfinfo set rname=?,remail=?,raddress=?,rmob=?,ruser=?,rpass=? where rname='"+sur+"'");
            pst.setString(1,sn);
            pst.setString(2,se);
            pst.setString(3,sa);
            pst.setString(4,sp);
