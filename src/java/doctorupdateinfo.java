 ...
 * @author microsoft
 */
public class doctorupdateinfo extends HttpServlet {
String sur;
    /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("update doctorselfinfo set dname=?,demail=?,daddress=?,dmob=?,duser=?,dpass=?,SPECIALIST=? where dname='"+sur+"'");
            pst.setString(1,sn);
            pst.setString(2,se);
            pst.setString(3,sa);
            pst.setString(4,sp);
