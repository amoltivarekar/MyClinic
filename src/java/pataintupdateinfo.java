 ...
 * @author microsoft
 */
public class pataintupdateinfo extends HttpServlet {
    String sur;
    /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("update pataintselfinfo set pname=?,pemail=?,paddress=?,pmob=?,puser=?,ppass=? where pname='"+sur+"'");
            pst.setString(1,sn);
            pst.setString(2,se);
            pst.setString(3,sa);
            pst.setString(4,sp);
