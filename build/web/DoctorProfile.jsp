...
<%
    try
    {
        ...
        pst=con.prepareStatement("select * from doctorselfinfo where dname='"+sur+"'");
        rs=pst.executeQuery();
        rs.next();
    }
    catch(Exception e)
...
<!--header end here-->
<!--content start here-->
<div style="padding:100px 0px 750px 0px; background: url(images/banner.jpg);background-size: cover;">
    <div>
                            ...
                            <form action="doctorupdateinfo" method="post" >                                  
                                    <div class="col-md-6 contact-right">
                                        ...
                                        <input placeholder="Speciality" type="text"  name="specialist"  value="<%=rs.getString(7)%>" style="background-color:rgba(255,255,255,.5); width:670px; color: #843534; font-weight: bold; font-size:18px; border-radius: 15px; border:solid 2px white;" onkeypress="return validateFm(event)" required>
    ...
    <div class="contact-bottom" style="margin-left:20px ;">
                            <form action="presenty" method="post" >                                  
                                    <div class="col-md-6 contact-right">
                                        ...
                                        <input placeholder="Employee Type" type="text"  name="jobtype"  value="Doctor" style="background-color:rgba(255,255,255,.5); width:400px; color: #843534; font-weight: bold; font-size:18px; border-radius: 15px; border:solid 2px white;" onkeypress="return validateFm(event)" readonly>
                                        <input placeholder="Speciality" type="text"  name="speciality"  value="<%=rs.getString(7)%>" style="background-color:rgba(255,255,255,.5); width:400px; color: #843534; font-weight: bold; font-size:18px; border-radius: 15px; border:solid 2px white;" onkeypress="return validateFm(event)" readonly>
