...
<div style="padding:100px 0px 700px 0px; background: url(images/banner.jpg);background-size: cover;">
    <div>
        ...
        <table width="95%">
            <tr>
                <td style="color:white; font-weight: bold; font-family:century gothics; font-size:15px; padding:10px 20px; margin:15px; background:rgba(65,24,27,.4);">
                    DOCTOR NAME
                </td>
                <td style="color:white; font-weight: bold; font-family:century gothics; font-size:15px; padding:10px 20px; margin:15px; background:rgba(65,24,27,.4);">
                    EMAIL ID
        ...
        <%while (rs.next())
        {
            %>
            <tr>
                <td style="color:white; font-weight: bold; font-family:century gothics; font-size:18px; padding:9px 20px; margin:5px 5px;  background:rgba(65,24,27,.2);">
                    <%=rs.getString(1)%>
                </td>
                <td style="color:white; font-weight: bold; font-family:century gothics; font-size:18px; padding:9px 20px;  margin:5px 5px; background:rgba(65,24,27,.2);" >
                    <%=rs.getString(2)%>
