...
<div style="padding:100px 0px 350px 0px; background: url(images/banner.jpg);background-size: cover;">
    <div>
                            ...
                            <div class="contact-bottom" style="margin-left:280px; ">
                                <form action="PatBill1.jsp" method="post" >                                  
                                        <div class="col-md-6 contact-right">
                                            <table width="100%">
                                                <tr >
                                                    <td style="font-weight: bold; color: #A73C46;">PATIENT NAME</td>
                                                    <td style="padding-left:150px;"><select  name="PatientName" style="background-color:rgba(255,255,255,.5); width:450px; color: #843534; font-weight: bold; font-size:18px; border-radius: 15px; border:solid 2px white; margin-bottom:20px;" readonly ><option><%=sur%></option></select></td>
                                                </tr>
                                                <tr>
